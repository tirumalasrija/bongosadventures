...
$default_thumb = Assets\asset_path('images/lessons/globe-monkeys.jpg');
...
<section class="featured-lessons">
    <div class="page-wrap">
		<div class="popupCode">
        <div class="container">
            <h2>Featured lessons for the week</h2>
            <div class="lesson-blocks">
                ...
                foreach ($lessons as $lesson) :
                    ...
                    $term = wp_get_post_terms($lesson->ID, 'bongosbooks_subject');
                  ...
                  //  if(wc_memberships_is_post_content_restricted($lesson->ID)) {
                    ...
                    ?>
                    <div <?php post_class($post_classes) ?> style="border-color: <?= $color ?>; background-image: url(<?= $thumb ?>)">
                        <a href="<?= get_the_permalink($lesson->ID) ?>">
                            <h4 style="background-color: <?= $color ?>"><?= $lesson->post_title ?>
