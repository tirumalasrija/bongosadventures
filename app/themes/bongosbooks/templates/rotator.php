                    ...
                    <div class="container">
                        ...
                        foreach ($lessons as $lesson) : ?>
                            <div class="callout">
                                ...
                                <div class="content">
                                    <p><?= get_the_excerpt($lesson->ID) ?></p>
                                    <a href="<?= get_the_permalink($lesson->ID) ?>" class="button">Learn More</a>
                                </div>
                                <?php $thumbnail = get_the_post_thumbnail_url($lesson->ID) ? get_the_post_thumbnail_url($lesson->ID) : Assets\asset_path('images/cereal-monkey.png'); ?>
                                <img src="<?= $thumbnail ?>" alt="Billy loves cereal!">
                            </div>
                        <?php endforeach; ?>
